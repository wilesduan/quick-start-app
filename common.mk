PROJECT_HOME=
DEP_LIBS_HOME=$(PROJECT_HOME)/dep_libs
...
UTIL_INCLUDE:=-I$(GEN_SDK_PATH)/util/include $(JSON_INCLUDE)
UTIL_LIB:=$(GEN_SDK_PATH)/util/lib/libutil.a $(JSON_LIB)

LIBSRVKIT_INCLUDE:=-I$(GEN_SDK_PATH)/libsrvkit/include
LIBSRVKIT_LIB:=$(GEN_SDK_PATH)/libsrvkit/lib/libserver.a

IM_PROTO_INCLUDE:=-I$(GEN_SDK_PATH)/proto/include
IM_PROTO_LIB:=$(GEN_SDK_PATH)/proto/lib/libproto.a
...
ALL_INCLUDES:=$(CURL_INCLUDE) $(JSON_INCLUDE) $(PROTOBUF_INCLUDE) $(OPENSSL_INCLUDE) $(ZOOKEEPER_INCLUDE) $(HIREDIS_VIP_INCLUDE) $(MYSQL_CONNECTOR_INCLUDE) $(UTIL_INCLUDE) $(LIBSRVKIT_INCLUDE) $(IM_PROTO_INCLUDE) $(APP_BO_INCLUDE) $(APP_STUB_INCLUDE) $(NGHTTP2_INCLUDE) $(RDKAFKA_INCLUDE) -I$(PROJECT_HOME)/apps/common
SYS_LIB:=-lrt -lpthread -ldl
ALL_LIBS:=$(APP_BO_LIB) $(APP_STUB_LIB) $(LIBSRVKIT_LIB) $(UTIL_LIB) $(IM_PROTO_LIB) $(CURL_LIB) $(JSON_LIB) $(PROTOBUF_LIB) $(OPENSSL_LIB) $(ZOOKEEPER_LIB) $(HIREDIS_VIP_LIB) $(MYSQL_CONNECTOR_LIB) $(NGHTTP2_LIB) $(RDKAFKA_LIB) $(SYS_LIB) $(TCMALLOC_LIB) 
